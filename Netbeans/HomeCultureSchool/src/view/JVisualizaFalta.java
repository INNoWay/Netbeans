...
public class JVisualizaFalta extends javax.swing.JFrame {

    public JVisualizaFalta() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new JVisualizaFalta().setVisible(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            cons=(java.sql.Connection) DriverManager.getConnection("jdbc:mysql://127.0.0.1/home","root","");
            
            String query = "SELECT M.codmateria,  SUM(B.faltas) Faltas FROM aluno A, boletim B, materia M WHERE A.RAaluno = B.RAaluno AND B.codmateria = M.codmateria AND A.RAaluno = ? GROUP BY  M.codmateria";
             
            java.sql.PreparedStatement consulta;
            
            consulta = cons.prepareStatement(query);
             
            consulta.setString(1,jTextField1.getText());
            ...
            Mode1.addRow(new Object[]{ rs.getString("codmateria"), rs.getString("Faltas")});
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new JVisualizaFalta().setVisible(true);
